    ...
    <section className="bg-white text-gray-900 py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          About <span className="text-blue-600">AI</span> Resume Generator
        </h2>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Our AI-powered tool helps you create professional, optimized resumes
          effortlessly. Using cutting-edge AI technology, it tailors your resume
          to highlight your skills, experience, and achievements, ensuring you
